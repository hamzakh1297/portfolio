...
const socials = [
  ...
  { label: "Email", href: "mailto:hamzabhai1297@gmail.com", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z" /><path d="m22 6-10 7L2 6" /></svg> },
];
...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`mailto:hamzabhai1297@gmail.com?subject=${subject}&body=${body}`, "_blank");
    setStatus("sent");
            ...
            <div className={styles.infoCard}>
              ...
              <div className={styles.infoItem}>
                ...
                <div>
                  ...
                  <a href="mailto:hamzabhai1297@gmail.com">hamzabhai1297@gmail.com</a>
                </div>
              </div>
              <div className={styles.infoItem}>
